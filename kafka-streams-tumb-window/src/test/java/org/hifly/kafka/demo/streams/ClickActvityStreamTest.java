...
import org.hifly.kafka.demo.streams.serializer.ClickActivityDeserializer;
import org.hifly.kafka.demo.streams.serializer.ClickActivitySerializer;
...
public class ClickActvityStreamTest {
    ...
    public void stream() throws Exception {
        ...
        streamsProps.put(StreamsConfig.APPLICATION_ID_CONFIG, "clickactivity_app_id");
        ...
        final Serializer<ClickActivity> clickActivitySerializer = new ClickActivitySerializer();
        final Deserializer<ClickActivity> clickActivityDeserializer = new ClickActivityDeserializer();
